...
class Cogroo:
    ...
    def lemmatize(self, text: object) -> object:
    ...
    def _pos_tags(self):
        ...
        pos.update({"v-pcp": "verbo partic�pio"})
        pos.update({"v-ger": "verbo ger�ndio"})
        pos.update({"num": "numeral"})
        pos.update({"prp": "preposi��o"})
        pos.update({"adj": "adjetivo"})
        pos.update({"conj": "conjun��o"})
        pos.update({"conj-s": "conjun��o subordinativa"})
        pos.update({"conj-c": "conjun��o coordenativa"})
        pos.update({"intj": "interjei��o"})
        pos.update({"adv": "adv�rbio"})
